...
document.getElementById("school").getElementsByTagName("span")[0].addEventListener("tap",function(){
	plus.webview.create("school.html", "school.html",{},{webView:plus.webview.currentWebview().id}).show();
	plus.webview.currentWebview().hide();
});
document.getElementById("company").getElementsByTagName("span")[0].addEventListener("tap",function(){
	plus.webview.create("company.html", "company.html",{},{webView:plus.webview.currentWebview().id}).show();
	plus.webview.currentWebview().hide();
});
document.getElementById("city").getElementsByTagName("span")[0].addEventListener("tap",function(){
	plus.webview.create("city.html", "city.html",{},{webView:plus.webview.currentWebview().id}).show();
	plus.webview.currentWebview().hide();
});

mui("#items").on("tap", ".itemLeft", function() {	
	plus.webview.create("jobItem.html", "jobItem.html",{},{webView:plus.webview.currentWebview().id}).show();
	plus.webview.currentWebview().hide();
});

mui("#items").on("tap", ".itemRight", function() {	
	plus.webview.create("jobItem.html", "jobItem.html",{},{webView:plus.webview.currentWebview().id}).show();
	plus.webview.currentWebview().hide();
});
